...
int main(int argc, char **argv)
{
  ...
  // double res_force = std::abs(FTsubscriber.wrench_external_(2));
  // ROS_INFO_STREAM("I heard: Force\n" << FTsubscriber.wrench_external_);
  // while (res_force < 15)
  // {
  //   ROS_INFO_STREAM("I heard: Force\n" << FTsubscriber.wrench_external_);
  //   dualArmRobot.graspMove(0.001, false, true, false);  // true : left arm; false: right arm
  //   res_force = std::abs(FTsubscriber.wrench_external_(2));
  // }
